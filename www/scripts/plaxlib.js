...
plax.fadeIn = function(objId,toOp,fromOp){var obj=$(objId);if(toOp>fromOp){plax.setOpacity(obj,fromOp);fromOp+=10;window.setTimeout("plax.fadeIn('"+objId+"',"+toOp+","+fromOp+")",10);}}
plax.fadeOut = function(objId,toOp,fromOp){var obj=$(objId);if(toOp<fromOp){plax.setOpacity(obj,fromOp);fromOp-=10;window.setTimeout("plax.fadeOut('"+objId+"',"+toOp+","+fromOp+")",10);}}
plax.setOpacity = function(obj,opacity){opacity=(opacity==100)?99.999:opacity;obj.style.filter="alpha(opacity:"+opacity+")";obj.style.KHTMLOpacity=opacity/100;obj.style.MozOpacity=opacity/100;obj.style.opacity=opacity/100;}
